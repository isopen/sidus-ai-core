### Bitget Integration Plugin

This plugin provides real-time WebSocket integration with the Bitget cryptocurrency exchange. It enables streaming of market data including tickers, order books, candlesticks, and trades for spot markets through WebSocket connections using the Bitget V2 public API.
