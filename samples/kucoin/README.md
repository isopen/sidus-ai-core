### KuCoin Integration Plugin

This plugin provides real-time WebSocket integration with the KuCoin cryptocurrency exchange (SPOT and FUTURES markets). It enables streaming of market data including tickers, order books, candlesticks, and trades through WebSocket connections using the KuCoin public API. The plugin supports both SPOT and FUTURES markets with separate WebSocket connections.
