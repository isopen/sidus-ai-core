### Kraken Integration Plugin

This plugin provides real-time WebSocket integration with the Kraken cryptocurrency exchange. It enables streaming of market data including tickers, order books, OHLC candles, and trades through WebSocket connections using the Kraken WebSocket API v2. The plugin supports real-time market data streaming for all major cryptocurrency pairs.
