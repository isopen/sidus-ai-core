### Etherscan API integration sample

This project provides a convenient interface for accessing Ethereum blockchain data via the official Etherscan API. Retrieve real-time information about wallet balances, transactions, ETH prices, gas fees, token data, and other on-chain metrics directly within your application.
